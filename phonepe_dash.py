...
db = psycopg2.connect(host='localhost', user='postgres', password='your password',database='phonepe')
cursor = db.cursor()
...
# MENU 1 - HOME
if selected == "Home":  
    image = Image.open("d:\phpelogo.png")
    ...
    st.markdown(
        "### :blue[Technologies used :] Github Cloning, Python, Pandas, PostgreSQL, Streamlit, and Plotly.")
    st.markdown(
...
if selected == "Explore Data":
    ...
    if Type == "Transactions":
        ...
        with col1:
            ...
            df2 = pd.read_csv(r"D:\python vs code\phonepe\Statenames.csv")
            df1.State = df2
